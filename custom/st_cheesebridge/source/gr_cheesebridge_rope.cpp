...
void grCheeseBridgeRope::startup(gfArchive* archive, u32 unk1, gfSceneRoot::LayerType layerType) {
    ...
    this->m_areaData.set(soAreaInstance::Shape_Rectangle, gfArea::Stage_Group_Gimmick_Ladder, 0, 0, 0, 0, Vec2f(0.0, (upperNode.m_y + underNode.m_y)/2), Vec2f(10.0, upperNode.m_y - underNode.m_y));
