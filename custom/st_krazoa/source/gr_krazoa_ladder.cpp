...
grKrazoaLadder* grKrazoaLadder::create(int mdlIndex, const char* taskName) {
    grKrazoaLadder* ladder = new (Heaps::StageInstance) grKrazoaLadder(taskName);
    ladder->setMdlIndex(mdlIndex);
    return ladder;
}

void grKrazoaLadder::startupLadder(gfArchive* archive, u32 unk1, gfSceneRoot::LayerType layerType, grGimmickLadderData* ladderData) {
...
void grKrazoaLadder::onGimmickEvent(soGimmickEventArgs* eventInfo, int* taskId) {
...
void grKrazoaLadder::setMotionPathData(int mdlIndex) {
